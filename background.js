const apiEndpoint = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=PUT_YOUR_API_KEY_HERE"; // Replace with your actual API key
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    const formattedText = `Is this information true or false?(answer with true or false) "${message.text}" If false, from what trusted sources can I find the correct info?`;
    ...
    fetch(apiEndpoint, {
        ...
        .then(data => {
            ...
            if (candidates.length > 0 && candidates[0].content && candidates[0].content.parts) {
                ...
                const explanation = responseParts[1]?.text.trim() || "";
