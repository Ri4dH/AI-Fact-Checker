const geminiApiEndpoint = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=Your_API_Key_Here"; // Your Gemini API Key

const googleSearchApiKey = "Your_Google_Search_API_Key_Here"; // Your Google Search API Key
const searchEngineId = "Your_Search_Engine_ID_Here"; // Your Search Engine ID
